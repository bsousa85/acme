...
@Component
@Profile("sql")
public interface IProductSQLDriver extends CrudRepository<ProductSQL, Long> {

    List<ProductSQL> findByDesignation(String designation);

    Optional<ProductSQL> findBySku(String sku);
    ...
    Optional<ProductSQL> getCatalog();
    ...
    ProductSQL updateBySku(@Param("sku") String sku);

    @Query("SELECT p FROM Product p WHERE p.productID=:productID")
    Optional<ProductSQL> findById(Long productID);
